...
const FarmCard: React.FC<FarmCardProps> = ({ farm }) => {
  ...
  return (
    <div className="farm-styled-cards">
      <div className="farm-styled-card">
        <div className="farm-card">
          <img src={EthereumIcon} className="img-fluid card-icon" />
          {/* <div className="card-icon">{farm.icon}</div> */}
          <h3>{farm.name}</h3>
          {/* <h6>TBD % APY</h6> */}
          <h6>
            APY{" "}
          ...
          <p>
            {" "}
            Deposit <span>{farm.lpToken.toUpperCase()}</span> to earn{" "}
            <span> {farm.earnToken.toUpperCase()}</span>{" "}
          </p>
          <Link to={`/farms`}>
            <button
              disabled={!poolActive}
              value={poolActive ? "Enter" : undefined}
            >
              {" "}
              {poolActive ? (
                "Enter"
